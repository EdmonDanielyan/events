...
// tests for CommentParent
void main() {
  final instance = CommentParentBuilder();
  // TODO add properties to the builder and call build()

  group(CommentParent, () {
    // BuiltList<Comment> children
    ...
    // DateTime dateCreate
    test('to test the property `dateCreate`', () async {
      // TODO
    });
    ...
    // String postText
    test('to test the property `postText`', () async {
      // TODO
    });
    ...
    // bool allowEdit
    test('to test the property `allowEdit`', () async {
      // TODO
    });

    // bool allowDelete
    test('to test the property `allowDelete`', () async {
      // TODO
    });
