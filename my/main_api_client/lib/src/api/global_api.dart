...
class GlobalApi {
  ...
  const GlobalApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [NotificationFullList] as data
  ...
  Future<Response<NotificationFullList>> getAllNotificationsState({ 
    ...
    final _path = r'/config/notifications';
    ...
    NotificationFullList? _responseData;
  ...
  ///
  /// Parameters:
  /// * [channel] - Тип события для подписки. На старте только для чатов
  /// * [targetId] - Id подписки
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NotificationSubState] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<NotificationSubState>> getNotificationSub({ 
    ...
    final _path = r'/config/notifications/{channel}/{targetId}'.replaceAll('{' r'channel' '}', channel.toString()).replaceAll('{' r'targetId' '}', targetId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    NotificationSubState? _responseData;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GlobalSettingsResponseBody] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GlobalSettingsResponseBody>> getSettings({ 
    ...
    GlobalSettingsResponseBody? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GlobalSettingsResponseBody),
      ) as GlobalSettingsResponseBody;
  ...
  Future<Response<NotificationSubState>> setNotificationSub({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'value': encodeQueryParameter(_serializers, value, const FullType(bool)),
    };
