...
class _$GetUserSuccess extends GetUserSuccess {
  ...
  factory _$GetUserSuccess([void Function(GetUserSuccessBuilder)? updates]) =>
      (new GetUserSuccessBuilder()..update(updates))._build();
  ...
  _$GetUserSuccess._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        success, r'GetUserSuccess', 'success');
    BuiltValueNullFieldError.checkNotNull(host, r'GetUserSuccess', 'host');
    BuiltValueNullFieldError.checkNotNull(
        version, r'GetUserSuccess', 'version');
    BuiltValueNullFieldError.checkNotNull(
        returned, r'GetUserSuccess', 'returned');
    BuiltValueNullFieldError.checkNotNull(status, r'GetUserSuccess', 'status');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetUserSuccess')
          ..add('data', data)
          ..add('success', success)
          ..add('host', host)
          ..add('version', version)
...
class GetUserSuccessBuilder
    implements
        Builder<GetUserSuccess, GetUserSuccessBuilder>,
  ...
  @override
  void replace(covariant GetUserSuccess other) {
  ...
  @override
  GetUserSuccess build() => _build();

  _$GetUserSuccess _build() {
    final _$result = _$v ??
