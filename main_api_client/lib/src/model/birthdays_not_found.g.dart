...
class _$BirthdaysNotFound extends BirthdaysNotFound {
  ...
  _$BirthdaysNotFound._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(code, r'BirthdaysNotFound', 'code');
    BuiltValueNullFieldError.checkNotNull(
        detail, r'BirthdaysNotFound', 'detail');
    BuiltValueNullFieldError.checkNotNull(title, r'BirthdaysNotFound', 'title');
    BuiltValueNullFieldError.checkNotNull(
        status, r'BirthdaysNotFound', 'status');
    BuiltValueNullFieldError.checkNotNull(
        success, r'BirthdaysNotFound', 'success');
    BuiltValueNullFieldError.checkNotNull(host, r'BirthdaysNotFound', 'host');
    BuiltValueNullFieldError.checkNotNull(
        version, r'BirthdaysNotFound', 'version');
    BuiltValueNullFieldError.checkNotNull(
        returned, r'BirthdaysNotFound', 'returned');
    BuiltValueNullFieldError.checkNotNull(type, r'BirthdaysNotFound', 'type');
    BuiltValueNullFieldError.checkNotNull(
        instance, r'BirthdaysNotFound', 'instance');
  }
...
class BirthdaysNotFoundBuilder
    implements
        Builder<BirthdaysNotFound, BirthdaysNotFoundBuilder>,
  ...
  BirthdaysNotFoundBuilder() {
    BirthdaysNotFound._defaults(this);
  }
  ...
  @override
  void replace(covariant BirthdaysNotFound other) {
    ...
    final _$result = _$v ??
        new _$BirthdaysNotFound._(
            code: BuiltValueNullFieldError.checkNotNull(
                code, r'BirthdaysNotFound', 'code'),
            detail: BuiltValueNullFieldError.checkNotNull(
                detail, r'BirthdaysNotFound', 'detail'),
            title: BuiltValueNullFieldError.checkNotNull(
                title, r'BirthdaysNotFound', 'title'),
            status: BuiltValueNullFieldError.checkNotNull(
                status, r'BirthdaysNotFound', 'status'),
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'BirthdaysNotFound', 'success'),
            host: BuiltValueNullFieldError.checkNotNull(
                host, r'BirthdaysNotFound', 'host'),
            version: BuiltValueNullFieldError.checkNotNull(
                version, r'BirthdaysNotFound', 'version'),
            returned: BuiltValueNullFieldError.checkNotNull(
                returned, r'BirthdaysNotFound', 'returned'),
            type: BuiltValueNullFieldError.checkNotNull(
                type, r'BirthdaysNotFound', 'type'),
            instance: BuiltValueNullFieldError.checkNotNull(instance, r'BirthdaysNotFound', 'instance'));
    replace(_$result);
    return _$result;
  }
}
