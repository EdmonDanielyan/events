...
class _$GetContactsSerializer implements PrimitiveSerializer<GetContacts> {
  @override
  final Iterable<Type> types = const [GetContacts, _$GetContacts];

  @override
  final String wireName = r'GetContacts';
  ...
  void _deserializeProperties(
    ...
    required GetContactsBuilder result,
  ...
  @override
  GetContacts deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GetContactsBuilder();
