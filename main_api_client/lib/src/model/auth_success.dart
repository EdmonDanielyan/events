...
class _$AuthSuccessSerializer implements PrimitiveSerializer<AuthSuccess> {
  @override
  final Iterable<Type> types = const [AuthSuccess, _$AuthSuccess];

  @override
  final String wireName = r'AuthSuccess';
  ...
  void _deserializeProperties(
    ...
    required AuthSuccessBuilder result,
  ...
  @override
  AuthSuccess deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AuthSuccessBuilder();
