...
class ContentApi {
  ...
  Future<Response<SinglePageSuccessResponseBody>> getPage({ 
    ...
    SinglePageSuccessResponseBody? _responseData;
  ...
  Future<Response<ListPageSuccessResponseBody>> getPagesList({ 
    ...
    ListPageSuccessResponseBody? _responseData;
  ...
  Future<Response<SingleSectionSuccessResponseBody>> getPagesSection({ 
    ...
    SingleSectionSuccessResponseBody? _responseData;
  ...
  Future<Response<ListSectionSuccessResponseBody>> getPagesSectionsList({ 
    ...
    ListSectionSuccessResponseBody? _responseData;
  ...
  Future<Response<ListSnippetSuccessResponseBody>> getSnippetsList({ 
    ...
    ListSnippetSuccessResponseBody? _responseData;
  ...
  Future<Response<UniEventsGetDetailRespBody>> uniEventsGetDetail({ 
    ...
    UniEventsGetDetailRespBody? _responseData;
    ...
    return Response<UniEventsGetDetailRespBody>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UniEventsGetListRespBody>> uniEventsGetList({ 
    ...
    UniEventsGetListRespBody? _responseData;
    ...
    return Response<UniEventsGetListRespBody>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
