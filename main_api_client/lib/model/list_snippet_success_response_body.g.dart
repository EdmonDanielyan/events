...
Serializer<ListSnippetSuccessResponseBody>
    _$listSnippetSuccessResponseBodySerializer =
    new _$ListSnippetSuccessResponseBodySerializer();

class _$ListSnippetSuccessResponseBodySerializer
    implements StructuredSerializer<ListSnippetSuccessResponseBody> {
  @override
  ...
  @override
  final String wireName = 'ListSnippetSuccessResponseBody';

  @override
  Iterable<Object> serialize(
      Serializers serializers, ListSnippetSuccessResponseBody object,
  ...
  ListSnippetSuccessResponseBody deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ListSnippetSuccessResponseBodyBuilder();
...
class ListSnippetSuccessResponseBodyBuilder
  ...
  ListSnippetSuccessResponseBodyBuilder() {
    ListSnippetSuccessResponseBody._initializeBuilder(this);
  }
  ...
  @override
  void replace(ListSnippetSuccessResponseBody other) {
