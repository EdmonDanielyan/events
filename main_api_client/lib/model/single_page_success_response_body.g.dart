...
Serializer<SinglePageSuccessResponseBody>
    _$singlePageSuccessResponseBodySerializer =
    new _$SinglePageSuccessResponseBodySerializer();

class _$SinglePageSuccessResponseBodySerializer
    implements StructuredSerializer<SinglePageSuccessResponseBody> {
  @override
  ...
  @override
  final String wireName = 'SinglePageSuccessResponseBody';

  @override
  Iterable<Object> serialize(
      Serializers serializers, SinglePageSuccessResponseBody object,
  ...
  SinglePageSuccessResponseBody deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SinglePageSuccessResponseBodyBuilder();
...
class SinglePageSuccessResponseBodyBuilder
  ...
  SinglePageSuccessResponseBodyBuilder() {
    SinglePageSuccessResponseBody._initializeBuilder(this);
  }
  ...
  @override
  void replace(SinglePageSuccessResponseBody other) {
