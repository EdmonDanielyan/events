...
Serializer<AlreadyEventMember> _$alreadyEventMemberSerializer =
    new _$AlreadyEventMemberSerializer();

class _$AlreadyEventMemberSerializer
    implements StructuredSerializer<AlreadyEventMember> {
  @override
  final Iterable<Type> types = const [AlreadyEventMember, _$AlreadyEventMember];
  @override
  final String wireName = 'AlreadyEventMember';

  @override
  Iterable<Object> serialize(Serializers serializers, AlreadyEventMember object,
  ...
  @override
  AlreadyEventMember deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new AlreadyEventMemberBuilder();
...
class _$AlreadyEventMember extends AlreadyEventMember {
  ...
  factory _$AlreadyEventMember(
      ...
      (new AlreadyEventMemberBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AlreadyEventMember')
          ..add('title', title)
          ..add('detail', detail)
          ..add('status', status)
          ..add('code', code)
...
class AlreadyEventMemberBuilder
    implements Builder<AlreadyEventMember, AlreadyEventMemberBuilder> {
  ...
  AlreadyEventMemberBuilder() {
    AlreadyEventMember._initializeBuilder(this);
  }
  ...
  @override
  void replace(AlreadyEventMember other) {
