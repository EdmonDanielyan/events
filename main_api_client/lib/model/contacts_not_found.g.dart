...
Serializer<ContactsNotFound> _$contactsNotFoundSerializer =
    new _$ContactsNotFoundSerializer();

class _$ContactsNotFoundSerializer
    implements StructuredSerializer<ContactsNotFound> {
  @override
  final Iterable<Type> types = const [ContactsNotFound, _$ContactsNotFound];
  @override
  final String wireName = 'ContactsNotFound';

  @override
  Iterable<Object> serialize(Serializers serializers, ContactsNotFound object,
  ...
  ContactsNotFound deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ContactsNotFoundBuilder();
...
class ContactsNotFoundBuilder
    implements Builder<ContactsNotFound, ContactsNotFoundBuilder> {
  ...
  ContactsNotFoundBuilder() {
    ContactsNotFound._initializeBuilder(this);
  }
  ...
  @override
  void replace(ContactsNotFound other) {
