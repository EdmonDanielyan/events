...
Serializer<NewsLikeSuccess> _$newsLikeSuccessSerializer =
    new _$NewsLikeSuccessSerializer();

class _$NewsLikeSuccessSerializer
    implements StructuredSerializer<NewsLikeSuccess> {
  @override
  final Iterable<Type> types = const [NewsLikeSuccess, _$NewsLikeSuccess];
  @override
  final String wireName = 'NewsLikeSuccess';

  @override
  Iterable<Object> serialize(Serializers serializers, NewsLikeSuccess object,
  ...
  @override
  NewsLikeSuccess deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new NewsLikeSuccessBuilder();
...
class _$NewsLikeSuccess extends NewsLikeSuccess {
  ...
  factory _$NewsLikeSuccess([void Function(NewsLikeSuccessBuilder) updates]) =>
      (new NewsLikeSuccessBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('NewsLikeSuccess')
          ..add('data', data)
          ..add('success', success)
          ..add('host', host)
          ..add('version', version)
...
class NewsLikeSuccessBuilder
    implements Builder<NewsLikeSuccess, NewsLikeSuccessBuilder> {
  ...
  NewsLikeSuccessBuilder() {
    NewsLikeSuccess._initializeBuilder(this);
  }
  ...
  @override
  void replace(NewsLikeSuccess other) {
