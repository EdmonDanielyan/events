...
Serializer<OrderReferenceFail> _$orderReferenceFailSerializer =
    new _$OrderReferenceFailSerializer();

class _$OrderReferenceFailSerializer
    implements StructuredSerializer<OrderReferenceFail> {
  @override
  final Iterable<Type> types = const [OrderReferenceFail, _$OrderReferenceFail];
  @override
  final String wireName = 'OrderReferenceFail';

  @override
  Iterable<Object> serialize(Serializers serializers, OrderReferenceFail object,
  ...
  OrderReferenceFail deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new OrderReferenceFailBuilder();
...
class OrderReferenceFailBuilder
    implements Builder<OrderReferenceFail, OrderReferenceFailBuilder> {
  ...
  OrderReferenceFailBuilder() {
    OrderReferenceFail._initializeBuilder(this);
  }
  ...
  @override
  void replace(OrderReferenceFail other) {
