...
Serializer<EventsNotFound> _$eventsNotFoundSerializer =
    new _$EventsNotFoundSerializer();

class _$EventsNotFoundSerializer
    implements StructuredSerializer<EventsNotFound> {
  @override
  final Iterable<Type> types = const [EventsNotFound, _$EventsNotFound];
  @override
  final String wireName = 'EventsNotFound';

  @override
  Iterable<Object> serialize(Serializers serializers, EventsNotFound object,
  ...
  @override
  EventsNotFound deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new EventsNotFoundBuilder();
...
class _$EventsNotFound extends EventsNotFound {
  ...
  factory _$EventsNotFound([void Function(EventsNotFoundBuilder) updates]) =>
      (new EventsNotFoundBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('EventsNotFound')
          ..add('title', title)
          ..add('detail', detail)
          ..add('status', status)
          ..add('code', code)
...
class EventsNotFoundBuilder
    implements Builder<EventsNotFound, EventsNotFoundBuilder> {
  ...
  EventsNotFoundBuilder() {
    EventsNotFound._initializeBuilder(this);
  }
  ...
  @override
  void replace(EventsNotFound other) {
