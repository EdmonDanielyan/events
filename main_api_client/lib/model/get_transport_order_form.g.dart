...
Serializer<GetTransportOrderForm> _$getTransportOrderFormSerializer =
    new _$GetTransportOrderFormSerializer();

class _$GetTransportOrderFormSerializer
    implements StructuredSerializer<GetTransportOrderForm> {
  @override
  final Iterable<Type> types = const [
    GetTransportOrderForm,
    _$GetTransportOrderForm
  ];
  @override
  final String wireName = 'GetTransportOrderForm';

  @override
  Iterable<Object> serialize(
      Serializers serializers, GetTransportOrderForm object,
      ...
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(
                BuiltList, const [const FullType(TransportForm)])));
    }
  ...
  GetTransportOrderForm deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GetTransportOrderFormBuilder();
...
class _$GetTransportOrderForm extends GetTransportOrderForm {
  ...
  factory _$GetTransportOrderForm(
      ...
      (new GetTransportOrderFormBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetTransportOrderForm')
          ..add('data', data)
          ..add('success', success)
          ..add('host', host)
          ..add('version', version)
...
class GetTransportOrderFormBuilder
    implements Builder<GetTransportOrderForm, GetTransportOrderFormBuilder> {
  ...
  set data(ListBuilder<TransportForm> data) => _$this._data = data;
  ...
  GetTransportOrderFormBuilder() {
    GetTransportOrderForm._initializeBuilder(this);
  }
  ...
  @override
  void replace(GetTransportOrderForm other) {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GetTransportOrderForm', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
