...
Serializer<EmptySearch> _$emptySearchSerializer = new _$EmptySearchSerializer();

class _$EmptySearchSerializer implements StructuredSerializer<EmptySearch> {
  @override
  final Iterable<Type> types = const [EmptySearch, _$EmptySearch];
  @override
  final String wireName = 'EmptySearch';

  @override
  Iterable<Object> serialize(Serializers serializers, EmptySearch object,
  ...
  @override
  EmptySearch deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new EmptySearchBuilder();
...
class _$EmptySearch extends EmptySearch {
  ...
  factory _$EmptySearch([void Function(EmptySearchBuilder) updates]) =>
      (new EmptySearchBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('EmptySearch')
          ..add('title', title)
          ..add('detail', detail)
          ..add('status', status)
          ..add('code', code)
...
class EmptySearchBuilder implements Builder<EmptySearch, EmptySearchBuilder> {
  _$EmptySearch _$v;
  ...
  EmptySearchBuilder() {
    EmptySearch._initializeBuilder(this);
  }
  ...
  @override
  void replace(EmptySearch other) {
