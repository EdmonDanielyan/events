...
class _$NotFoundSerializer implements StructuredSerializer<NotFound> {
  ...
  NotFound deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new NotFoundBuilder();
...
class _$NotFound extends NotFound {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('NotFound')
          ..add('status', status)
          ..add('code', code)
          ..add('success', success)
          ..add('host', host)
...
class NotFoundBuilder implements Builder<NotFound, NotFoundBuilder> {
  ...
  NotFoundBuilder() {
    NotFound._initializeBuilder(this);
  }
