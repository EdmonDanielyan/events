...
Serializer<SendFeedbackFail> _$sendFeedbackFailSerializer =
    new _$SendFeedbackFailSerializer();

class _$SendFeedbackFailSerializer
    implements StructuredSerializer<SendFeedbackFail> {
  @override
  final Iterable<Type> types = const [SendFeedbackFail, _$SendFeedbackFail];
  @override
  final String wireName = 'SendFeedbackFail';

  @override
  Iterable<Object> serialize(Serializers serializers, SendFeedbackFail object,
  ...
  @override
  SendFeedbackFail deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SendFeedbackFailBuilder();
...
class _$SendFeedbackFail extends SendFeedbackFail {
  ...
  factory _$SendFeedbackFail(
      ...
      (new SendFeedbackFailBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('SendFeedbackFail')
          ..add('title', title)
          ..add('detail', detail)
          ..add('status', status)
          ..add('code', code)
...
class SendFeedbackFailBuilder
    implements Builder<SendFeedbackFail, SendFeedbackFailBuilder> {
  ...
  SendFeedbackFailBuilder() {
    SendFeedbackFail._initializeBuilder(this);
  }
  ...
  @override
  void replace(SendFeedbackFail other) {
