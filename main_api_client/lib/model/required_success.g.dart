...
class _$RequiredSuccess extends RequiredSuccess {
  ...
  factory _$RequiredSuccess([void Function(RequiredSuccessBuilder) updates]) =>
      (new RequiredSuccessBuilder()..update(updates)).build();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc($jc(0, success.hashCode), host.hashCode), version.hashCode),
            returned.hashCode),
        status.hashCode));
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('RequiredSuccess')
          ..add('success', success)
          ..add('host', host)
          ..add('version', version)
