...
Serializer<AlreadyThanked> _$alreadyThankedSerializer =
    new _$AlreadyThankedSerializer();

class _$AlreadyThankedSerializer
    implements StructuredSerializer<AlreadyThanked> {
  @override
  final Iterable<Type> types = const [AlreadyThanked, _$AlreadyThanked];
  @override
  final String wireName = 'AlreadyThanked';

  @override
  Iterable<Object> serialize(Serializers serializers, AlreadyThanked object,
  ...
  AlreadyThanked deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new AlreadyThankedBuilder();
...
class AlreadyThankedBuilder
    implements Builder<AlreadyThanked, AlreadyThankedBuilder> {
  ...
  AlreadyThankedBuilder() {
    AlreadyThanked._initializeBuilder(this);
  }
  ...
  @override
  void replace(AlreadyThanked other) {
