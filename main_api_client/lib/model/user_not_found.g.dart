...
Serializer<UserNotFound> _$userNotFoundSerializer =
    new _$UserNotFoundSerializer();

class _$UserNotFoundSerializer implements StructuredSerializer<UserNotFound> {
  @override
  final Iterable<Type> types = const [UserNotFound, _$UserNotFound];
  @override
  final String wireName = 'UserNotFound';

  @override
  Iterable<Object> serialize(Serializers serializers, UserNotFound object,
  ...
  @override
  UserNotFound deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new UserNotFoundBuilder();
...
class _$UserNotFound extends UserNotFound {
  ...
  factory _$UserNotFound([void Function(UserNotFoundBuilder) updates]) =>
      (new UserNotFoundBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('UserNotFound')
          ..add('title', title)
          ..add('detail', detail)
          ..add('status', status)
          ..add('code', code)
...
class UserNotFoundBuilder
  ...
  UserNotFoundBuilder() {
    UserNotFound._initializeBuilder(this);
  }
