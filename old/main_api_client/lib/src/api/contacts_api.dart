...
class ContactsApi {
  ...
  ///
  /// Parameters:
  /// * [search] - Строка, введенная пользователем для поиска
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetContacts] as data
  ...
  Future<Response<GetContacts>> getContacts({ 
    ...
    GetContacts? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetContacts),
      ) as GetContacts;
