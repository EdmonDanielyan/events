...
class AnnouncementsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetAnnouncementById] as data
  ...
  Future<Response<GetAnnouncementById>> getAnnouncementById({ 
    ...
    final _path = r'/announcements/{id}'.replaceAll('{' r'id' '}', id.toString());
    ...
    GetAnnouncementById? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAnnouncementById),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetAnnouncements] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetAnnouncements>> getAnnouncements({ 
    ...
    GetAnnouncements? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAnnouncements),
      ) as GetAnnouncements;
