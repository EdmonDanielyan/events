...
@injectable
class EventsAndAnnouncementsBlockCubit
    extends Cubit<EventsAndAnnouncementsBlockState> {
  EventsAndAnnouncementsBlockCubit()
      : super(EventsAndAnnouncementsBlockState(
            EventsAndAnnouncementsBlockStateType.EVENTS));
