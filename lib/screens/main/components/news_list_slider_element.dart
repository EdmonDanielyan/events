      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          child: GestureDetector(
            onTap: () {
              Navigator.pushNamed(context, '/news_detail', arguments: {'id': newsItem.id});
            },
            child: Container(
              decoration: BoxDecoration(
                color: Colors.white,
                      ...
                      Expanded(
                        child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                    newsItem.dateCreate != null ? DateFormat('dd.MM.yyyy').format(newsItem.dateCreate!) : '',
                                    style: TextStyle(
                                                      ...
                                                      child: Row(
                                                          children: [
                                                            ...
                                                            Container(
                                                                margin: EdgeInsets.only(left: 4),
                                                                child: Text(
                                                                    newsItem.commentCount != null ? newsItem.commentCount.toString() : '0',
                                                                    style: TextStyle(
                                                            ...
                                                            Row(
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                      margin: EdgeInsets.only(left: 4),
                                                                      child: Text(
                                                                          newsItem.viewCount != null ? newsItem.viewCount.toString() : '0',
                                                                          style: TextStyle(
                                                                            color: Theme.of(context).iconTheme.color,
                                                                          )
                                                                      )
