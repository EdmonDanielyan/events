...
class AnnouncementsList extends StatelessWidget {
    ...
    return BlocProvider<AnnouncementsListCubit>(
        ...
        child: BlocBuilder<AnnouncementsListCubit, AnnouncementsListState>(
            builder: (context, state) {
              final AnnouncementsListCubit announcementsCubit = BlocProvider.of<AnnouncementsListCubit>(context);
              ...
              switch (state.type) {
                ...
                case AnnouncementsListStateType.ERROR: {
                  final MainPageCubit mainPageCubit = BlocProvider
  ...
  List<Widget> getAnnouncementsWidgetList(List<AnnouncementData> announcements) {
