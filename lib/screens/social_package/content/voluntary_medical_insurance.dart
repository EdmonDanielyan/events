...
class VoluntaryMedicalInsurance extends StatefulWidget {
  ...
  @override
  State<VoluntaryMedicalInsurance> createState() =>
      _VoluntaryMedicalInsuranceState();
}

class _VoluntaryMedicalInsuranceState extends State<VoluntaryMedicalInsurance> {
  ...
  Container oldTextWidget(bool isTablet) {
    return Container(
