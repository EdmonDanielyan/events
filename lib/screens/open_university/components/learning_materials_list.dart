...
class LearningMaterialsList extends StatelessWidget {
  ...
  static const String TITLE = 'Обучающие материалы';
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      color: Colors.green,
      displacement: 20,
      child: BlocBuilder<LearningMaterialsListCubit, LearningMaterialsListState>(
                ...
                return Container(
                  ...
                  child: Column(
                      children: [
                        ...
                        Container(
                            child: Column(
                                children: _getLearningMaterialsWidgetList(
                                    state.data!
                                )
                            )
                        )
  ...
  List<LearningMaterialsListElement> _getLearningMaterialsWidgetList(List<LearningMaterialsData> learningMaterialsList) {
    List<LearningMaterialsListElement> _learningMaterialsWidgetList = [];

    learningMaterialsList.forEach((value) {
      _learningMaterialsWidgetList.add(
          LearningMaterialsListElement(learningMaterial: value)
      );
    });
