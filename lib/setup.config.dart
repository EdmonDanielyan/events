...
import 'components/new_bottom_nav_bar/cubit/new_bottom_nav_bar_cubit.dart'
    as _i41;
import 'constants/files.dart' as _i83;
import 'constants/urls.dart' as _i82;
...
import 'core/errors/file_log_appender.dart' as _i80;
import 'core/handlers/AuthHandler.dart' as _i79;
...
import 'cubit/chat_list/chat_list_cubit.dart' as _i18;
...
import 'providers/nats_provider.dart' as _i81;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i18.ChatListCubit>(() => _i18.ChatListCubit());
  ...
  gh.singleton<_i79.AuthHandler>(_i79.AuthHandler(get<_i13.BootCubit>()));
  gh.singleton<_i80.FileLogAppender>(
      _i80.FileLogAppender(get<String>(instanceName: 'logFile')));
  gh.lazySingleton<_i81.NatsProvider>(() => _i81.NatsProvider(
...
class _$Urls extends _i82.Urls {}

class _$FileConstants extends _i83.FileConstants {}
