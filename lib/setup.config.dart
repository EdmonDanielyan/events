...
import 'core/handlers/AuthHandler.dart' as _i74;
...
import 'cubit/personnel_movements/sources/network.dart' as _i71;
...
import 'cubit/references/references_cubit.dart' as _i66;
import 'cubit/references/sources/check_permission/network.dart' as _i61;
import 'cubit/references/sources/get_autofill_data/network.dart' as _i62;
...
import 'cubit/tags_list/sources/network.dart' as _i73;
import 'cubit/tags_list/tags_list_cubit.dart' as _i72;
...
import 'providers/main_api.dart' as _i63;
import 'providers/nats_provider.dart' as _i64;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i62.GetAutofillNetworkRequest>(
      _i62.GetAutofillNetworkRequest());
  gh.singleton<_i63.MainApiProvider>(_i63.MainApiProvider());
  gh.singleton<_i64.NatsProvider>(_i64.NatsProvider());
  gh.singleton<_i65.NewBottomNavBarCubit>(_i65.NewBottomNavBarCubit());
  gh.singleton<_i66.ReferencesPageCubit>(_i66.ReferencesPageCubit());
  ...
  gh.singleton<_i71.StaffMovementsNetworkRequest>(
      _i71.StaffMovementsNetworkRequest());
  gh.singleton<_i72.TagsListCubit>(_i72.TagsListCubit());
  gh.singleton<_i73.TagsListNetworkRequest>(_i73.TagsListNetworkRequest());
  gh.singleton<_i74.AuthHandler>(_i74.AuthHandler(get<_i60.BootCubit>()));
  return get;
}
