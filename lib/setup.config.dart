...
import 'components/new_bottom_nav_bar/cubit/new_bottom_nav_bar_cubit.dart'
    as _i40;
import 'constants/urls.dart' as _i112;
...
import 'core/logging/file_log_appender.dart' as _i85;
...
import 'cubit/chat_db/chat_table_cubit.dart' as _i83;
...
import 'functions/chat/channel_functions.dart' as _i91;
import 'functions/chat/chat_creation.dart' as _i93;
import 'functions/chat/chat_functions.dart' as _i84;
...
import 'functions/chat/listeners/chat_info.dart' as _i102;
import 'functions/chat/listeners/chat_list.dart' as _i106;
import 'functions/chat/listeners/delete_message.dart' as _i101;
import 'functions/chat/listeners/invitation.dart' as _i105;
import 'functions/chat/listeners/joined.dart' as _i103;
import 'functions/chat/listeners/left.dart' as _i104;
import 'functions/chat/listeners/message_status.dart' as _i109;
import 'functions/chat/listeners/online.dart' as _i108;
import 'functions/chat/listeners/text_message.dart' as _i100;
import 'functions/chat/listeners/texting.dart' as _i107;
import 'functions/chat/send_message.dart' as _i88;
...
import 'functions/chat/sender/ping_sender.dart' as _i97;
import 'functions/chat/sender/text_sender.dart' as _i98;
import 'functions/chat/sender/user_reaction_sender.dart' as _i90;
import 'functions/chat/user_functions.dart' as _i89;
import 'models/announcement_data.dart' as _i8;
import 'models/chat/database/chat_db.dart' as _i82;
...
import 'models/token.dart' as _i64;
...
import 'providers/message_provider.dart' as _i39;
import 'providers/nats_provider.dart' as _i87;
import 'providers/package_info.dart' as _i54;
import 'providers/security_checker.dart' as _i65;
import 'screens/feedback/components/form/entities.dart' as _i69;
import 'screens/initial/cubit/initial_cubit.dart' as _i86;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i64.SecureStorage>(() => _i64.SecureStorage());
  gh.factory<_i65.SecurityChecker>(() => _i65.SecurityChecker());
  ...
  gh.lazySingleton<_i64.TokenDataHolder>(() => _i64.TokenDataHolder());
  gh.factory<_i80.Uint8List>(() => certificateInjector.natsCertificate,
  ...
  gh.factory<_i84.ChatFunctions>(() =>
      _i84.ChatFunctions(get<_i83.ChatDatabaseCubit>(), get<_i39.Messenger>()));
  gh.lazySingleton<_i85.FileLogAppender>(
      () => _i85.FileLogAppender(get<String>(instanceName: 'logFile')));
  gh.factory<_i86.InitialCubit>(() => _i86.InitialCubit(
      get<_i65.SecurityChecker>(),
      get<_i15.CertificateReader>(),
      get<_i81.AuthHandler>()));
  gh.lazySingleton<_i35.MainApiProvider>(() => _i35.MainApiProvider(
      get<_i35.LogInterceptor>(),
      get<String>(instanceName: 'apiUrl'),
      get<_i80.Uint8List>(instanceName: 'apiCertificate')));
  gh.lazySingleton<_i87.NatsProvider>(() => _i87.NatsProvider(
      ...
      certificate: get<_i80.Uint8List>(instanceName: 'natsCertificate')));
  gh.factory<_i88.SendMessage>(() => _i88.SendMessage(
      chatFunctions: get<_i84.ChatFunctions>(),
      chatDatabaseCubit: get<_i83.ChatDatabaseCubit>()));
  gh.factory<_i89.UserFunctions>(
      () => _i89.UserFunctions(get<_i83.ChatDatabaseCubit>()));
  gh.factory<_i90.UserReactionSender>(() => _i90.UserReactionSender(
      get<_i87.NatsProvider>(), get<_i84.ChatFunctions>()));
  gh.factory<_i91.ChannelFunctions>(
      () => _i91.ChannelFunctions(get<_i83.ChatDatabaseCubit>()));
  gh.lazySingleton<_i92.ChannelsRegistry>(() => _i92.ChannelsRegistry(
      natsProvider: get<_i87.NatsProvider>(),
      channelFunctions: get<_i91.ChannelFunctions>(),
      userFunctions: get<_i89.UserFunctions>(),
      chatDatabaseCubit: get<_i83.ChatDatabaseCubit>()));
  gh.factory<_i93.ChatCreation>(() => _i93.ChatCreation(
      get<_i83.ChatDatabaseCubit>(),
      get<_i89.UserFunctions>(),
      get<_i39.Messenger>()));
  gh.factory<_i94.ChatSaver>(
      () => _i94.ChatSaver(get<_i82.ChatDatabase>(), get<_i87.NatsProvider>()));
  gh.factory<_i95.InviteSender>(() => _i95.InviteSender(
      get<_i87.NatsProvider>(),
      get<_i89.UserFunctions>(),
      get<_i84.ChatFunctions>(),
      get<_i94.ChatSaver>(),
      get<_i82.ChatDatabase>(),
  ...
  gh.factory<_i96.MessageEditorSender>(() => _i96.MessageEditorSender(
      ...
      get<_i84.ChatFunctions>(),
      get<_i82.ChatDatabase>()));
  gh.factory<_i97.PingSender>(() =>
      _i97.PingSender(get<_i87.NatsProvider>(), get<_i89.UserFunctions>()));
  ...
  gh.factory<_i99.ChannelListener>(
      () => _i106.ChatListListener(
          ...
          get<_i83.ChatDatabaseCubit>(),
          get<_i89.UserFunctions>(),
          get<_i91.ChannelFunctions>(),
          get<_i94.ChatSaver>(),
          get<_i93.ChatCreation>()),
      instanceName: 'ChatList');
  gh.factory<_i99.ChannelListener>(
      () => _i107.MessageTextingListener(
          get<_i87.NatsProvider>(),
          get<_i92.ChannelsRegistry>(),
          get<_i83.ChatDatabaseCubit>(),
          get<_i16.ChatCubit>()),
  ...
  gh.factory<_i99.ChannelListener>(
      ...
      instanceName: 'Online');
  gh.factory<_i99.ChannelListener>(
      () => _i109.MessageStatusListener(get<_i87.NatsProvider>(),
          get<_i92.ChannelsRegistry>(), get<_i84.ChatFunctions>()),
...
class _$UrlsConfigTest extends _i112.UrlsConfigTest {}

class _$LogFilePathInjector extends _i111.LogFilePathInjector {}

class _$UrlsConfigProd extends _i112.UrlsConfigProd {}

class _$TokenDataInjectorModule extends _i64.TokenDataInjectorModule {}

class _$UrlsConfigDev extends _i112.UrlsConfigDev {}
